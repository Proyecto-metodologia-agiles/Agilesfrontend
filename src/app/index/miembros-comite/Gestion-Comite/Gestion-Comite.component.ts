...
@Component({
	selector: 'Gestion-Comite',
	templateUrl: './Gestion-Comite.component.html',
	styleUrls: ['./Gestion-Comite.component.css']
})

export class GestionComiteComponent implements OnInit {
